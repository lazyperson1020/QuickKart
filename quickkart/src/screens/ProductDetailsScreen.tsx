...
export default function ProductDetails() {
  ...
  useEffect(() => {
    ...
    AsyncStorage.getItem(`notify_sub_${product.sku}`)
      .then((val) => setIsSubscribed(val === '1'));
  }, []);
        ...
        <View style={styles.infoMetaBlock}>
          ...
          {product.brand && !['generic', 'n/a', 'na', 'none', 'unknown'].includes(product.brand.toLowerCase()) ? (
            <TouchableOpacity
              ...
              activeOpacity={0.75}
              onPress={() =>
                navigation.navigate('BrandProducts', { brand: product.brand! })
              }
            >
              <Image
        ...
        <View style={styles.internalDockFlexRow}>
          ...
          <Animated.View style={[styles.purpleCartButtonWrapper, animatedCartButtonStyle]}>
            <TouchableOpacity
              ...
              onPress={() => totalCartCount > 0 && navigation.navigate('Cart')}
            >
          ...
          <Animated.View style={[styles.rightActionButtonSqueezeTarget, animatedAddButtonContainerStyle]}>
            {currentQuantity > 0 ? (
              ...
              <TouchableOpacity
                style={[styles.notifyMeButton, isSubscribed && styles.notifyMeButtonActive]}
                activeOpacity={0.8}
