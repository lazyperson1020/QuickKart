...
import { removePaymentOffer } from '../../app/redux/couponSlice';
...
export default function CouponCard() {
  ...
  const goToCoupons = useSinglePress(() => router.push({ pathname: '/(tabs)/coupons' as any, params: { tab: 'coupons' } }));
  const goToPayment = useSinglePress(() => router.push({ pathname: '/(tabs)/coupons' as any, params: { tab: 'payment' } }));
