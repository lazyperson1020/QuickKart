    ...
    (item: CategoryItem) => {
      if (item.firebaseCategory) {
        router.push({
          ...
          params: { category: item.firebaseCategory, categoryTitle: item.label.replace('\n', ' ') },
        } as any);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <View style={styles.headerIcons}>
          ...
          <TouchableOpacity hitSlop={8} style={{ marginLeft: 16 }} onPress={() => router.push('/(tabs)/search/results' as any)}>
